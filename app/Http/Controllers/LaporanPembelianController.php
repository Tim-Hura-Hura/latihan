...
public function index()
	{
        ...
        $hasil = $laba11-$laba22;
		return view ('admin/laporan_pembelian',['data'=>$data,'pemasukan'=>$pemasukan,'pengeluaran'=>$pengeluaran,'hasil'=>$hasil,'pemasukan2'=>$pemasukan2,'pengeluaran2'=>$pengeluaran2,'tgl1'=>$tgl1,'tgl2'=>$tgl2]); 
 	}
...
public function admin_laporan_pembelian_sort(Request $request)
 {
 	if(!Session::get('login'))
             {
            return redirect('login');
