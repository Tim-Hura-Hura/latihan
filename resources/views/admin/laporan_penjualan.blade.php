                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <form method="POST" enctype="multipart/form-data" action="{{url('admin_laporan_penjualan_sort')}}">
                                                        {{csrf_field()}}

                                                        <table class="table ">
                                                            <div class="control-group">
                                                                        <ul id="myTab3" class="tab-review-design">
                                                                            <li class="active"><a href="#description"><i class="fa fa-check" aria-hidden="true"></i> Laporan Penjualan</a></li>
                                                                        </ul>                                                                        
                                                            </div> <br> <br> 
                                                        <tr>
                                                             <th> 
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Laporan <span class="table-project-n">Penjualan</span></h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="klr">Tanggal Keluar</th>
                                                <th data-field="mk">Mekanik</th>
                                                <th data-field="pnm">Penerima</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">   
                                                    <a href="{{url('admin_penjualan_detail_list',$dt->id_nota)}}" class="btn btn-success btn-block" style="color: #ffffff">Detail</a> 
                                                </td>
                                            </tr>
                                         @endforeach  
