                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <form method="POST" enctype="multipart/form-data" action="{{url('kasir_detail_sort')}}">
                                                        {{csrf_field()}}
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="datatable-ct">   
                                                    <a href="{{url('kasir_detail_list',$dt->id_nota)}}" class="btn btn-success btn-block" style="color: #ffffff">Detail</a> 
                                                </td>
                                            </tr>
                                         @endforeach  
