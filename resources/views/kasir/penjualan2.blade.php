                                                            ...
                                                            <div class="review-content-section">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="card-number"erateNop class="form-label">Nopol</label>
                                                                     <input id="nopol" name="nopol" type="text" class="form-control"  readonly="" value="{{$records->nopol}}"></input> 
                                  
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="card-number" class="form-label">Nama Mekanik</label>
                                                                    <input id="mekanik" name="mekanik" type="text" class="form-control"  readonly="" value="{{$records->mekanik}}"></input> 
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="card-number" class="form-label">Nama Penerima</label>
                                                                    <input id="penerima" name="penerima" type="text" class="form-control"  readonly="" value="{{$records->penerima}}"></input> 
                                                                </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="review-content-section">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="jumlah" name="jumlah" type="number" value="0" min="0" max="0" class="form-control">
                                                                </div>
                                                                <div class="form-group">
                        ...
                        <div class="sparkline13-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tbody id="tabelnya">
                                    @foreach($detail as $records2)
                                       <tr>
                                            <td>{{$records2->nama_barang_jasa}}</td>
                                            <td>{{$records2->jumlah}}</td>
                                            <td>{{$records2->harga_jual}}</td>
                                            <td>{{$records2->sub_total}}</td>
                                            <td><button class='fa fa-trash btn btn-danger' onclick="deletedetail('{{$records2->id}}')"></button></td>
                                      </tr>
                                    @endforeach
                                    </tbody>
                                </table>
    ...
    <script type="text/javascript">
        function ajaxGenerateKodeBarang(status) {
            ...
            if (status=="kode") {
                ...
                $.ajax({
                    method: "GET",
                    url: "../ajax/generateKodeBarang2/" + link_id,
                    dataType: "json",
                    data: {_token: _token},
                    success: function (data) {
                        if (!$.trim(data)) {
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        function bayar() {
            ...
            $.ajax({
                type: "PUT",
                url: "../kasir_penjualan2_bayar/"+id_nota,
                data: {
                    id_nota: id_nota,
                    nopol: nopol,
                    mekanik: mekanik,
