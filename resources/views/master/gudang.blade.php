            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="{{url('gudang_barang')}}">
                                   <i class="fa big-icon fa-dropbox   icon-wrap"></i>
                                   <span class="mini-click-non">Data Sparepart</span>
                                </a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Landing Page" href="{{url('gudang_barang')}}" aria-expanded="false"><i class="fa fa-cube icon-wrap sub-icon-mg" aria-hidden="true"></i> <span class="mini-click-non">Master Barang</span></a>
                                </li> 
                                 <li><a title="View Mail" href="{{url('gudang_stok')}}"><i class="fa fa-th-large  sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Stok</span></a></li>                            
                            </ul>
                        </li>    
                        <li>
                            <a class="has-arrow" href="{{url('gudang_pembelian')}}">
                                   <i class="fa big-icon fa-list-alt icon-wrap"></i>
                                   <span class="mini-click-non">Data Transaksi</span>
                                </a>
                            <ul class="submenu-angle" aria-expanded="true">
                                 <li><a title="Inbox" href="{{url('gudang_pembelian')}}"><i class="fa fa-shopping-cart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Pembelian</span></a></li>
                                 <li><a title="View Mail" href="{{url('gudang_detail')}}"><i class="fa fa-list-ol sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Detail Pembelian</span></a></li>
                          ...
                          <li>
                            <a class="has-arrow" href="{{url('gudang_pembelian')}}">
                                   <i class="fa big-icon fa-history icon-wrap"></i>
                                   <span class="mini-click-non">Data Histori</span>
                                </a>
                            <ul class="submenu-angle" aria-expanded="true">
                                 <li><a title="Inbox" href="{{url('gudang_histori_pembelian')}}"><i class="fa fa-shopping-cart sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Histori Pembelian</span></a></li>
                                 <li><a title="View Mail" href="{{url('gudang_histori_penjualan')}}"><i class="fa fa-outdent sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Histori Penjualan</span></a></li>
